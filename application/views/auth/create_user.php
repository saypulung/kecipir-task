<div class="box">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
              ...
              <?php if ($this->ion_auth->is_admin()): ?>
                <div class="form-group">
                  <label><?php echo lang('create_user_groups_heading');?>:</label>
                </div>
                  <?php foreach ($groups as $group):?>
                    <div class="form-group">
                    <label class="checkbox">
                    
                    <input type="checkbox" class="minimal" name="groups[]" value="<?php echo $group['id'];?>">
    ...
    <div class="box-footer">
          <div class="row">
            <div class="col-md-12">
            <?php echo form_button( array('type'=>'submit', 'content'=>lang('create_user_submit_btn'),'class'=>'btn btn-primary'));?>
